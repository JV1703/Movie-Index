package com.example.movieindex.feature.main.ui.home.adapter.pageTransformer
...
class SliderPageTransformer(private val offscreenPageLimit: Int) : ViewPager2.PageTransformer {
    ...
    override fun transformPage(page: View, position: Float) {
        page.apply {
            ...
            when {
                position <= 0f -> {
                    // 0 is the current focus item
                    // <0 item offscreen left
                    translationX = DEFAULT_TRANSLATION_X
                    scaleX = DEFAULT_SCALE
                    scaleY = DEFAULT_SCALE
                    // when item is <0 make it invisible
